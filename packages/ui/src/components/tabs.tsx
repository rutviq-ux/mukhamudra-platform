...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center gap-4 border-b border-border text-muted-foreground",
      className
    )}
    {...props}
  />
