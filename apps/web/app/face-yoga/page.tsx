...
import { FaceYogaContent } from "@/components/services/face-yoga-content";
...
export default function FaceYogaPage() {
  const {
    ...
    redirectPage: "/face-yoga",
    productLabel: "Face Yoga",
    allPlans: ALL_PLANS,
    ...
    <>
      ...
      <div className="relative z-10 px-6 pt-20 pb-0">
        <nav className="mx-auto max-w-6xl flex items-center gap-1.5 text-sm text-muted-foreground">
          ...
          <span>/</span>
          <span className="text-foreground">Face Yoga</span>
        </nav>
      </div>
